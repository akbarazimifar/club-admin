...
import { handleAlertAndSelectApi } from "./../../../../../Containers/Common/method/handleAlertAndSelectApi/index";
...
export const update_change_introducer = (
  ...
  return async (dispatch) => {
    ...
    try {
      ...
      let introducerMemberId = responseMember.data.response.data.results[0].id
