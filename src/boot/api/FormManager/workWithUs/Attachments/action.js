...
import { WORK_WITH_US_V1_SELECT_ATTACHMENTS } from "../../../typeActions";



export const workwithus_v1_select_attachments_actions = (data) => {
    return async (dispatch) => {
      ...
      try {
        ...
        dispatch({
            type: WORK_WITH_US_V1_SELECT_ATTACHMENTS,
