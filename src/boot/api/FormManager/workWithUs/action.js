...
export const work_with_us_v1_select_actions = (size, from, data, sort_by) => {
    return async (dispatch) => {
      ...
      dispatch({ type:   WORK_WITH_US_V1_SELECT_LOADING, payload: true });
      ...
      try {
        ...
        dispatch({
          type:     WORK_WITH_US_V1_SELECT,
          payload: res.data,
        });
  
        dispatch({ type: WORK_WITH_US_V1_SELECT_LOADING, payload: false });
      } catch (err) {
