...
export default function Index({stateImages , SetStateImages }) {
    ...
    return (
        <Box width="100%" className={Styles['grid']} >
            <div className={Styles['defualtImages']}
                style={!stateImages.image 
                    ?{
            ...
            >
                    {
                        stateImages.image && (
                            <img className={Styles['img']} src={`data:image/png;base64,${stateImages.image}`} alt="" />
                        )
                    }
            </div>
            <Box width="95%">
