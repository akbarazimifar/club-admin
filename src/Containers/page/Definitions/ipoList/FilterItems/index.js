...
export default function Index({
    flagFilter, stateFilter, handleChangeFilter, handelSubmitFilter,handleChange,valueIpo
}) {
                            ...
                            <Box className={Styles['filter']} >
                                ...
                                <Autocomplete
                                    ...
                                    {/* <TextField
                                        ...
                                        style={{ minWidth: 250 }}
                                    >
                                        {titleReducer.data.map((title,index)=>(                            
                                ...
                                <Box width={250} className={Styles['TextField']} >
                                    <TextField
                                        ...
                                        onChange={(event) => handleChangeFilter(event.target.value, "member_bourse_account")}
                                        helperText=""
                                        size="small"
                                        fullWidth
                                        variant="outlined"
