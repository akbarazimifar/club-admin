...
export default function Index({  setOpen }) {
    ...
    const data = useSelector(state => state.bonus_calculate_confiict_reducer).data
            ...
            <div className={classes['info_1']}>
                ...
                <p>
                    <span>شناسه باشگاه</span>:
                             <span>
                        {
                            data.length > 0 ? data[0].body.automation_member_automation_club_id : ""
                        }
                    </span>
                </p>
                <p>
                    <span>شناسه اتوماسیون</span>:
                             <span>
                        {
                            data.length > 0 ? data[0].body.automation_member_automation_id : ""
                        }
                    </span>
                </p>
                {/* <p>
