                            ...
                            data.data.length !== 0 && (
                                data.data.map((row, ind) => (
                                    ...
                                    >
                                        ...
                                        <TableCell className="colorInherit" align="center">
                                            {toFixed(row.body.member_available_bonus)}
                                            {/* {seprateNumberFromComma(row.body.value)} */}
                                        </TableCell>
                                        <TableCell className="colorInherit" align="center">{row.body.member_account_code}</TableCell>
                                        <TableCell className="colorInherit" align="center">
                                            {toFixed(row.body.value)}
                                            {/* {seprateNumberFromComma(row.body.value)} */}
                                        </TableCell>
                                        ...
                                        <TableCell className="colorInherit" align="center">{handleNull(row.body.internal_description)}</TableCell>
                                    </TableRow>
                                ))
                            )
                        }
