...
export default function Index() {
    ...
    const reducerTotalBonus = useSelector(state => state.select_total_bonus_reducer)
    const reducerCount = useSelector(state => state.select_clubmember_count_reducer)
    const reducerRegistrationCount = useSelector(state => state.select_clubmember_registration_count_reducer)
    const reducerByBourseCodeCount = useSelector(state => state.select_clubmember_by_bourse_code_count_reducer)
    const reducerLogin = useSelector(state => state.select_clubmember_daily_login_log_reducer)
