...
const tableHead = [
  { label: "نام مخفف نماد", title: null, active: false },
  { label: "نام کامل شرکت", title: "30_char_persian_symbol", active: false },
  ...
  { label: "ارزش کل", title: "total_value", active: false, format: checkPrice },
  { label: "آخرین قیمت", title: "last_price", active: false, format: checkPrice },
  { label: " قیمت بسته شدن", title: "close_price", active: false, format: checkPrice },
  { label: "قدرت خرید حقیقی", title: "individual_buy_power", active: false, format: checkPrice },
  { label: "قدرت خرید حقوقی", title: "non_individual_buy_power", active: false, format: checkPrice },
  { label: "بازه قیمت", title: "price_range", active: false, format: checkPrice }
]
