...
import { stock_v1_actions_update } from "../../../../../boot/api/stock/mangement_data_stock/stock_v1_update/action";
import { stock_v1_actions_insert } from "../../../../../boot/api/stock/mangement_data_stock/stock_v1_insert/action";
...
export default function Index({ info, data }) {
  ...
  const handleSubmitEdit = (state, id) => {
    ...
    dispatch(stock_v1_actions_update({ ...obj, _id: id }))
    setNewButton(false)
  }
  ...
  const handleSubmitInsert = (data) => {
    ...
    dispatch(stock_v1_actions_insert(obj))
    setNewButton(false)
  }
