...
const Index = () => {
  ...
  let textData = [ //eslint-disable-line  no-sparse-arrays
    {
      date: "1400/08/26",
      version: "نسخه 1.4.9",
      title: "",
      list: [
        ...
        {
          text: "برداشته شدن محدویت کد رهگیری پستی از 6 رقم به 24 رقم در صفحه جوایز",
          per: type.insert,
        },
        {
          text: "اضافه شدن امکان مرتب سازی در صفحات ( شعب ، پیشخوان، معاملات ، صدای مشتری براساس تاریخ ،پست براساس شعب )",
          per: type.insert,
        },
      ],
    },
    {
      ...
      list: [
        ...
        {
          text: "امکان ویرایش  و ایجاد  فیلدهای ( کالا ، کد رهگیری پستی ) در صفحه  جوایز",
          per: type.insert,
        },
        {
    ...
    },
    {
      ...
      list: [
        ...
        {
          text: "امکان مشاهده لیست ثبت نام کنندگان  هر دوره در قسمت ابزار صفحه دوره های آموزشی",
          per: type.insert,
        },
        {
          text: "اضافه شدن فیلد های ( دسته بندی ، کد های دوره ) به قسمت فیلترینگ دوره های آموزشی",
          per: type.insert,
        },
        {
          text: "اضافه شدن فیلد( امتیاز جایزه ) به جدول و  خروجی اکسل  در صفحه لیست درخواست های جوایز",
          per: type.insert,
        },
        {
          text: "اضافه شدن فیلترینگ  براساس فیلد های ( کد ملی ، نماد ، وضعیت ، توضیحات ) در صفحه تغییر ناظر",
          per: type.insert,
        },
        {
        ...
        {
          text: "اصلاح خروجی اکسل صفحه دوره های آموزشی و اضافه شدن فیلد ( کد دوره ) به خروجی اکسل آن",
          per: type.update,
        },
      ],
    },
    {
      ...
      list: [
        ...
        {
          text: "اضافه شدن امکان مرتب سازی در صفحات (تغییر ناظر ، لیست کاربران ، لیست ورود و خروج کاربران ، درخواست های مشتری شدن ، گزارش امتیازات ، گزارش تجمیعی ،جوایز ، لیست جوایز ، کد های تخفیف ، دوره های آموزشی ، اعلانات ، مدیریت داده های سهام ، مسابقات ، تعریف عرضه اولیه ، فرم همکاری با ما ، فرم تماس با ما)",
          per: type.insert,
        },
        {
          text: "اصلاح امکان نهایی کردن دسته ای جوایز",
        ...
        {
          text: "اصلاح خروجی اکسل گزارش تجمیعی جوایز و گزارش تجمعی جوایز شارژ نقدی ",
          per: type.update,
        },
        {
    ...
    },
    {
      ...
      list: [
        ...
        {
          text: "اصلاح خطا در قسمت فلیترینگ گزارش امتیازات براساس تاریخ و کدملی",
          per: type.titleFixid,
        },
      ],
    },
    {
      ...
      list: [
        ...
        {
          text: "اضافه شدن فیلد امتیاز در دسترس ( مانده حساب ) درصفحه گزارش امتیازات",
          per: type.insert,
        },
        {
          text: "اصلاح خروجی اکسل لیست درخواست ها در صفحه جوایز و نمایش نام کاربری در خروجی اکسل ",
          per: type.update,
        },
        {
    ...
    },
    {
      ...
      list: [
        ...
        {
          text: "اضافه شدن شماره موبایل و کدپستی در خروجی اکسل درخواست های جوایز",
          per: type.update,
        },
        {
        ...
        {
          text: "اضافه شدن فیلترهای جدید به جستجوی پیشرفته در صفحه گزارش تجمیعی جوایز ( نام و نام خانوادگی ، کد ملی ، کد تفصیلی ، وضعیت ،امتیاز)",
          per: type.update,
        },
        {
          text: "اضافه شدن فیلترهای جدید به جستجوی پیشرفته در صفحه گزارش امتیازات (امتیاز رزرو شده ، کد تفصیلی ، رنج تاریخ ایجاد ، رنج تاریخ اعمال)",
          per: type.update,
        },
        {
    ...
    },
    {
      ...
      list: [
        ...
        {
          text: "دو مرحله ای شدن کسر ، رزرو ، اضافه کردن امتیاز(یک مرحله نمایش اطلاعات کدملی وارد شده و مرحله بعد عملیات امتیاز)",
          per: type.update,
        },
      ],
    },
    ...
    },
    {
      ...
      list: [
        {
          text: "اصلاح pagination و sort در صفحات اعلانات، دوره های آموزشی، دفاتر پیشخوان، لیست کاربران، گزارش معاملات، درخواست های مشتری شدن، شعب، امتیارات و لیست عرضه اولیه انجام شد.",
          per: type.update,
        },
        {
    ...
    },
    {
      ...
      list: [
        {
          text: "اصلاح pagination در جوایز و لیست درخواست های جوایز و لیست کاربران و درخواست های مشتری شدن انجام شد.",
          per: type.update,
        },
        {
          text: "امکان خروجی اکسل برای صفحات عرضه اولیه،شعب،دفاتر پیشخوان و شعب انجام شد.",
          per: type.insert,
        },
        {
        ...
        {
          text: "اضافه شدن تاریخ های ثبت و بسته شدن در فیلتر صفحه ی درخواست های جوایز انجام شد.",
          per: type.update,
        },
        {
        ...
        {
          text: "اضافه شدن قابلیت sort در صفحه ی جوایز و درخواست های جوایز انجام شد.",
          per: type.insert,
        },
      ],
    },
    ...
    },
    {
      ...
      list: [
        ...
        {
          text: "امکان خروجی اکسل برای تمام رکوردهای قسمت دوره های آموزشی و لیست کاربران",
          per: type.insert,
        },
      ],
    },
...

    {
      ...
      list: [
        ...
        {
          text: "اضافه شدن صفحه لیست کاربران به همراه فیلترها و جزئیات درخواست شده",
          per: type.insert,
        },
