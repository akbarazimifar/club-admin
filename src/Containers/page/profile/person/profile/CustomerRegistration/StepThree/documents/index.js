                        ...
                        <>
                            {
                                state[indexItem].pathImage.split('.')[1] === 'jpg' && (
                                    <img src={`/assets/images/profile/${state[indexItem].pathImage}`} alt={''} className={classes['images']} />
                                )
                            }
                            {
                                state[indexItem].pathImage.split('.')[1] === 'pdf' && (
                                    <iframe src={`/assets/images/profile/${state[indexItem].pathImage}`} className={classes['pdf']}> </iframe>//eslint-disable-line  jsx-a11y/iframe-has-title
                                )
                            }
                        </>
                    )
