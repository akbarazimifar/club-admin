...
import { workwithus_v1_select_attachments_actions } from "../../../../../boot/api/FormManager/workWithUs/Attachments/action";
import { WORK_WITH_US_V1_SELECT_ATTACHMENTS_EMPTY } from "../../../../../boot/api/typeActions";
...
export default function ModalWork_Attachments({ data }) {
  const classes = useStyles();
  const dispatch = useDispatch();

  const stateReducer = useSelector(
    (state) => state.workwithus_v1_select_attachments_reducer
  );
