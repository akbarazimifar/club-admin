          ...
          <Box className={Styles["filter"]}>
            ...
            <Box width={250} className={Styles["TextField"]}>
              <TextField
                ...
                label={"موقعیت شغلی"}
                value={stateFilter.job_position}
                onChange={(event) =>
                  handleChangeFilter(event.target.value, "job_position")
                }
                helperText=""
                size="small"
                fullWidth
            ...
            <Box width={250} className={Styles["TextField"]}>
              ...
              >
                ...
                <MenuItem value="SUBMITTED">بررسی نشده</MenuItem>
                <MenuItem value="FINALIZED">بررسی شده</MenuItem>
              </TextField>
            </Box>
          </Box>
