...
export default function Index({ handelShowFilterItems , HandelSubmit , data_Reducer  , api_call_select}) {
  
  const dataButtons = [
    { name: 'افزودن فرصت شغلی ', type: '', className: 'btnsBlue' },
  ]
  ...
  return (
    <div className={Styles['header']}>
      ...
      <div className={Styles['icon']}>
        ...
        >
        <Fade in={newButton}>
          <ModalAdd setNewButton={setNewButton} HandelSubmit={HandelSubmit} data_Reducer={data_Reducer} />
        </Fade>
      </Modal>
