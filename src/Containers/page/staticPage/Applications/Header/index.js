...
export default function Index({ handelShowFilterItems , dataPrev ,dataInsert , api_call_select}) {
  const dataButtons = [
    { name: 'افزودن دسته نرم افزار', type: '', className: 'btnsBlue' },
  ]
  ...
  return (
    <div className={Styles['header']}>
      ...
      <div className={Styles['icon']}>
        <FilterListIcon className={'disabledItems'} onClick={() => { handelShowFilterItems() }} />
